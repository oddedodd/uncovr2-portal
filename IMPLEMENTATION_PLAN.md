...
- [x] `P2.3` Build organization creation, approval, suspension and correction flows.
- [x] `P2.4` Show user memberships and resource hierarchy.
- [x] `P2.5` Build role correction and account suspension with confirmation and audit context.
- [x] `P2.6` Verify that superadmin operations use protected Laravel endpoints only.

### P2 gate

- [x] A superadmin can establish a label and its first administrator entirely in the portal.
